...
import { techDerksPosts } from '@/lib/posts-data';

export const metadata: Metadata = {
  title: 'TechDerks Insights — Insights from a Technician',
  description:
    'All posts from techderksinsights.blogspot.com — Docker, Linux, Web3, smart contracts, security, and IT workflows by Derrk Samuel.',
  alternates: { canonical: '/techderks' },
};
...
export default function TechDerksPage() {
  const featured = techDerksPosts[0];
  const rest = techDerksPosts.slice(1);
    ...
    <>
      ...
      <main id="main-content" className="min-h-screen bg-background">
        ...
        <section className="relative bg-primary pt-28 pb-16 overflow-hidden">
          ...
          <div className="absolute top-1/2 left-1/4 w-96 h-96 blob-accent opacity-30 pointer-events-none" aria-hidden="true" />
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
            <div className="flex items-center gap-3 mb-6">
              ...
              <span className="font-mono-tag text-accent">TechDerks</span>
            </div>
            <div className="flex items-center gap-3 mb-4">
              <div className="h-px w-8 bg-accent" />
              <span className="font-mono-tag text-accent">techderksinsights.blogspot.com</span>
            </div>
            ...
            <p className="text-white/60 text-base max-w-2xl leading-relaxed">
              ...
              platform is dedicated to helping modern independent professionals master their digital
              workflows safely and efficiently. We explore everything from high-performance hardware
              setups and local logistics tech to advanced network defense and malware analysis.
            </p>
            <div className="mt-8 flex items-center gap-4">
              <span className="tag-pill bg-white/10 text-white/60 border border-white/15">
                {techDerksPosts.length} Posts
              </span>
          ...
          <div className="mb-12">
            ...
            >
              {featured.image ? (
                ...
                <div className="bg-primary/10 flex items-center justify-center aspect-[16/10]">
                  <Icon name="ComputerDesktopIcon" size={64} className="text-accent/30" />
                </div>
              )}
