...
import { allPosts, Post, PostSection } from '@/lib/posts-data';
    ...
    <>
      ...
      <main id="main-content" className="min-h-screen bg-background">
        ...
        <section className="relative bg-primary pt-28 pb-12 overflow-hidden">
          ...
          <div className="absolute top-1/2 right-1/4 w-96 h-96 blob-accent opacity-20 pointer-events-none" aria-hidden="true" />
          <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
            ...
            <div className="flex items-center gap-2 mb-8 flex-wrap">
              ...
              <Link href="/blog" className="font-mono-tag text-white/40 hover:text-white/70 transition-colors">Blog</Link>
              <Icon name="ChevronRightIcon" size={12} className="text-white/30" />
            ...
            <div className="flex items-center gap-2 mb-4 flex-wrap">
              ...
              <span className="tag-pill bg-accent/20 text-accent border border-accent/30">blog.theweb3tech.com</span>
            </div>
            ...
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <p className="text-white/40 text-xs">TheWeb3Tech</p>
              </div>
            </div>
          </div>
        </section>
          ...
          <div className="grid lg:grid-cols-12 gap-10">
            ...
            <article className="lg:col-span-8">
              ...
              <div className="mt-6">
                ...
                >
                  View original post on blog.theweb3tech.com
              ...
              <div className="bg-card rounded-4xl border border-border p-6">
                ...
                >
                  ...
                  <div>
                    ...
                    <div className="text-xs text-muted">TheWeb3Tech</div>
                    <div className="text-xs text-muted mt-1">Crypto, Web3, Security &amp; Digital Innovation</div>
                  </div>
                </a>
              </div>
